    ...
    var t = {
        407: function (t, n, e) {
          ...
          function a(t) {
            return (
              void 0 === t && (t = "/"),
              v() ? location.pathname + location.search + location.hash : t
            );
          }
          function s(t) {
          ...
          function N(t, n) {
            ...
            function N(t, n, e, o) {
              return (
                (t = c(t) ? E(t) : t),
                { name: o || s(String(t)), path: t, handler: n, hooks: g(e) }
              );
            }
            function U(t, n) {
              if (!r.__dirty) {
            ...
            function F() {
              if (P)
                return (
                  (P
                    ? [].slice.call(
                        document.querySelectorAll(o.linksSelector || C)
                      )
                    : []
                  ).forEach(function (t) {
            ...
            function I(t, n, e) {
              ...
              if (o) {
                if (((r = o.path), n))
                  for (var a in n) r = r.replace(":" + a, n[a]);
                r = r.match(/^\//) ? r : "/" + r;
              }
              return (
                r &&
            ...
            t
              ...
              (this.navigateByName = function (t, n, e) {
                var o = I(t, n);
                return (
                  null !== o && (q(o.replace(new RegExp("^/?" + i), ""), e), !0)
                );
              }),
              ...
              (this.notFound = function (t, n) {
                return (
                  (r._notFoundRoute = N("*", t, [e, n], "__NOT_FOUND__")), this
                );
              }),
              (this.updatePageLinks = F),
              ...
              (this.matchLocation = function (t, n, e) {
                ...
                return (
                  y(o, function () {}),
                  "string" == typeof t && (t = void 0 === e || e ? E(t) : t),
                  l(o, {
                    name: String(t),
                    path: t,
                    handler: function () {},
              ...
              (this.addBeforeHook = T.bind(this, "before")),
              (this.addAfterHook = T.bind(this, "after")),
              (this.addAlreadyHook = T.bind(this, "already")),
              (this.addLeaveHook = T.bind(this, "leave")),
              (this.getRoute = z),
              (this._pathToMatchObject = M),
              (this._clean = s),
